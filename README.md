...
## V25 – Nhạc chỉ dành cho giáo viên
- PH/HS không thấy nút tải nhạc hoặc bật/tắt nhạc.
- Hai nút nhạc chỉ xuất hiện sau khi đăng nhập Firebase giáo viên:
  - `🎵 Tải nhạc`
  - `▶️ Bật nhạc / ⏸️ Tắt nhạc`
- Nhạc được lưu vào IndexedDB của chính trình duyệt giáo viên.
- Không dùng Firebase Storage.
- Không dùng GitHub để phát nhạc.
- Không đồng bộ nhạc sang máy PH/HS.
- Lần sau mở lại website trên cùng máy + cùng trình duyệt, bài nhạc vẫn còn.
- Nếu đổi máy hoặc xóa dữ liệu trình duyệt, cô tải lại bài nhạc.
- Âm thanh tưới nước/cộng-trừ điểm vẫn hoạt động độc lập.


## V26 FINAL – Nhạc giáo viên ổn định nhất
- Không dùng GitHub để phát nhạc.
- Không dùng Firebase Storage.
- Không dùng IndexedDB.
- PH/HS không thấy phần nhạc.
- Khi đăng nhập Firebase giáo viên, xuất hiện khung `Nhạc trên máy giáo viên`.
- Cô chọn file trực tiếp từ máy; website dùng URL tạm cục bộ và thẻ `<audio controls>` chuẩn của trình duyệt.
- Có nút Play/Pause/âm lượng ngay trên thanh audio.
- Tải lại trang thì chọn lại bài nhạc. Đây là phương án đơn giản và ít lỗi nhất.
- Khi đăng xuất giáo viên, nhạc tự dừng.
- Âm thanh tưới nước/cộng-trừ điểm vẫn độc lập.


## V27 – Cơ chế Bình nước 25/50/75/100
- Bỏ hoàn toàn nút `🔊 Hiệu ứng: Bật/Tắt`.
- Âm thanh hiệu ứng luôn hoạt động tự động.
- 25/100:
  - nắng ấm phủ vườn;
  - đốm sáng ✨;
  - âm thanh nhẹ 2 nốt.
...
- 100/100:
  - 🌈 cầu vồng;
  - ánh sáng vàng rực;
  - cả 40 bông hoa cùng nở và nhún;
  - âm thanh chúc mừng riêng;
  - hiện `🌸 CẢ KHU VƯỜN CÙNG NỞ RỘ! 🌸`;
  - hiện số lần lớp đã làm đầy Bình nước.
- Milestone event được lưu trong Firestore để các thiết bị đang mở khu vườn có thể nhận hiệu ứng mới.
